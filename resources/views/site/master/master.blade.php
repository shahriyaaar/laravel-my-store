...
<head>
    ...
    CSS
    ============================================= -->
    <link rel="stylesheet" href="{{url("asstes/css/site/linearicons.css")}}">
    <link rel="stylesheet" href="{{url("assets/css/site/font-awesome.min.css")}}">
    <link rel="stylesheet" href="{{url("asstes/css/site/nice-select.css")}}">
    <link rel="stylesheet" href="{{url("assets/css/site/magnific-popup.css")}}">
    <link rel="stylesheet" href="{{url("assets/css/public/bootstrap.min.css")}}">
    <link rel="stylesheet" href="{{url("assets/css/site/main.css")}}">
</head>
<body>
...
<script src="{{url("assets/js/public/jquery.js")}}"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4" crossorigin="anonymous"></script>
<script src="{{url("assets/js/public/bootstrap.min.js")}}"></script>
<script src="{{url("assets/js/public/bootstrap.bundle.min.js")}}"></script>
<script src="{{url("assets/js/site/jquery.ajaxchimp.min.js")}}"></script>
<script src="{{url("assets/js/site/jquery.nice-select.min.js")}}"></script>
<script src="{{url("assets/js/site/jquery.magnific-popup.min.js")}}"></script>
